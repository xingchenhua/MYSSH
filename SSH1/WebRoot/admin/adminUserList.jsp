                ...
                <div class="result-content">
                    ...
                    <div class="list-page"> 
                    	...
                    	<s:if test="page.hasNextPage==true">
                    	   <a href="adminUserAction.action?currentPage=<s:property value="%{currentPage+1}"/>">下一页</a>
                    	</s:if>
                    	<!-- 判断是有上一页，然后可以执行上一页跳转 -->
                    	<s:if test="page.hasPrePage==true">
                    	   <a href="adminUserAction.action?currentPage=<s:property value="%{currentPage-1}"/>">上一页</a>
                    	</s:if>
                    </div>
               </div>
            </form>
