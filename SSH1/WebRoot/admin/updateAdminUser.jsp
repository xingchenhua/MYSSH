			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span
						...
						href="/jscss/admin/design/">用户管理</a><span class="crumb-step">&gt;</span><span>修改管理员密码</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="adminUserAction!updateAdmin.action" method="post"
							...
							<tbody>
								...
								<tr>
									...
									<td><input class="common-text required" id="username"
										...
										value="<s:property value="adminUser.username"/>" type="text"
										readonly="readonly"></td>
									<td><input class="common-text required" id="id"
										name="id" size="50"
										value="<s:property value="adminUser.id"/>" type="hidden"
									></td>
								</tr>
