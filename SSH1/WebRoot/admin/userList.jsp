				...
				<ul class="sidebar-list">
					<li><a href="#"><i class="icon-font">&#xe003;</i>常用操作</a>
						<ul class="sub-menu">
							...
							<li><a href="../adminUserList.jsp"><i class="icon-font">&#xe005;</i>管理员管理</a></li>
				...
				<form action="" name="myform" id="myform" method="post">
					<div class="result-title">
						<div class="result-list">
							<a href="#"><i class="icon-font"></i>增加用户</a> <a id="batchDel"
					...
					<div class="result-content">
                    	...
                    	<s:if test="page.hasNextPage==true">
                    	   <a href="userAction.action?currentPage=<s:property value="%{currentPage+1}"/>">下一页</a>
                    	</s:if>
                    	<!-- 判断是有上一页，然后可以执行上一页跳转 -->
                    	<s:if test="page.hasPrePage==true">
                    	   <a href="userAction.action?currentPage=<s:property value="%{currentPage-1}"/>">上一页</a>
                    	</s:if>
						</div>
					</div>
				</form>
